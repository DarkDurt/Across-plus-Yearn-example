...
import { checkAllowance, approveToken } from '@/functions/acrossFunctions';
...
function BridgeAndDepositComponent() {
  ...
  const handleBridgeAndDeposit = async (e) => {
    // ADD CODE
  }
  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      ...
      <CardContent>
        <form onSubmit={handleBridgeAndDeposit} className="space-y-4">
